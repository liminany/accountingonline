...
public partial class ViewAds : System.Web.UI.Page
{
    ...
    private void ViewAdsImage(string imagesURL)
    {
        try
        {
            ...
            {
                div_Slider.InnerHtml = div_Slider.InnerHtml + "<div class='various' style='cursor:pointer;border:2px solid #333;height:168px;width:200px;float:right;margin-right: 10px;'><a class='fancybox' rel='gallery1' href='" + "../" + images[i].Replace("~", "..") + "'><img style='max-width: 200px;max-height: 168px;width:200px;height:168px;' src='" + "../" + images[i].Replace("~", "..") + "' alt='' /></a></div>";
            }
