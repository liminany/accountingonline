<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.master" AutoEventWireup="true"
    CodeFile="AddEditCity.aspx.cs" Inherits="Admin_AddEditCity" %>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" id="id-form" dir="rtl">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlCityStatus" runat="server" class="styledselect-year" Style="width: 250px;">
