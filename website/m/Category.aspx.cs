...
public partial class m_Category : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            _logger.Error("Mobile - Category:::Page_Load:::" + ex.Message);
        }
    }
    #endregion
    ...
    private void GetCustomersPageWise(int pageIndex)
    {
        try
        {
            ...
            using (SqlConnection con = new SqlConnection(constring))
            {
                using (SqlCommand cmd = new SqlCommand("sp_GetMainAdsSubCategoiresByCatIDMethods", con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@SubCatID", int.Parse(Request.QueryString["catID"].ToString()));
        ...
        {
            _logger.Error("Mobile - Category:::GetCustomersPageWise:::" + ex.Message);
        }
    }
    ...
    protected string GenerateURL(object strId, object Title)
    {
        ...
        strTitle = strTitle.Trim();
        strTitle = strTitle.Trim('-');
        strTitle = string.Format("../m/ViewAd.aspx?AdsID={0}", strId, strTitle);
        return strTitle;
    }
    #endregion
}